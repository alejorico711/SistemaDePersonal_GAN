using SistemaDePersonal_GAN.Formularios.EMPLEADOS;
...
{
    public partial class FRMEpleado : Form
    {
        ClsEmpleado miempleado;
        public FRMEpleado(ClsEmpleado empleado)
        {
            InitializeComponent();
        ...
        {
            AbrirFormularioHijo(new FRMDatosPersonales(miempleado));
        }

        private void btnTareas_Click(object sender, EventArgs e)
        {
            AbrirFormularioHijo(new FRMTareasEmpleado(miempleado));
        }
